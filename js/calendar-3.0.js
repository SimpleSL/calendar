...
function calendar_init(obj,args){
	...
	if(cal_width < 160){
		obj.html("<span style='color:red'>错误：日历区域宽度小于160px，日历无法正常显示!</span>");
		return;
	}
	...
	btn_year_down.children("span").click(function(e){
		...
		calendar_core(val,obj,date_active_color);
	...
	line1.find("div").css("float","left")
		...
		.css("line-height",pane_height + "px")
		.css("font-size","80%")
	...
	calendar_core(date_value.text(),obj,date_active_color);
}

//约定：val为“2016年9月这样的字符串”
function calendar_core(val,obj,date_active_color){
